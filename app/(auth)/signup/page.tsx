...
export default function SignupPage() {
  ...
  const userRole = fd.get('userRole') as string;
    ...
    try {
      // First create user in Next.js (Prisma) for NextAuth credentials & social linking
      ...
      // Mirror registration in Laravel backend; surface failures to user instead of silently ignoring
      try {
