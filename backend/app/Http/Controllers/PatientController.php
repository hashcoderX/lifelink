...
class PatientController extends Controller
{
    ...
    public function update(Request $request, Patient $patient)
    {
        ...
        $data = $request->validate([
            ...
            'current_creatinine' => ['sometimes','numeric','min:0'],
            'gfr' => ['sometimes','numeric','min:0'],
            'diagnosis' => ['sometimes','string'],
            'urgent_level' => ['sometimes', Rule::in(['LOW','MEDIUM','HIGH','CRITICAL'])],
            ...
            'hiv_status' => ['sometimes', Rule::in(['POSITIVE','NEGATIVE'])],
            'hbv_status' => ['sometimes', Rule::in(['POSITIVE','NEGATIVE'])],
            'hcv_status' => ['sometimes', Rule::in(['POSITIVE','NEGATIVE'])],
